  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Your display name and avatar across the dashboard.
        </CardDescription>
      </CardHeader>
      <CardContent>
    ...
    <Card>
      ...
      <CardContent>
        <Field>
          ...
          <FieldDescription>
            Changing your sign-in email requires verification — contact support
            to update it.
          </FieldDescription>
        </Field>
      </CardContent>
    ...
    <div className="mx-auto flex w-full max-w-2xl flex-col gap-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Manage your personal profile and sign-in credentials.
        </p>
      </div>
