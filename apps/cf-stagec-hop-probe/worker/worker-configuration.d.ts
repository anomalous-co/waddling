/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 268b20e7aa19378edd07080b05b46b70)
// Runtime types generated with workerd@1.20260616.1 2026-06-01 nodejs_compat
interface __BaseEnv_Env {
	GATEWAY_HOST: "example.com";
	Sandbox: DurableObjectNamespace<import("./src/index").HopProbeSandbox>;
	GATEWAY_DO: DurableObjectNamespace<import("./src/index").GatewayStubDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "HopProbeSandbox" | "GatewayStubDO";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GATEWAY_HOST">> {}
}
